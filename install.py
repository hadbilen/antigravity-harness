...
def install_guard_binary(script_dir: Path, from_source: bool = False) -> str:
    ...
    release_url = f"https://github.com/hadbilen/antigravity-harness/releases/download/v1.2.7/{binary_name}"
    print(f"[FETCH] Downloading standalone binary from GitHub Releases ({binary_name})...")
    try:
        import urllib.request
        req = urllib.request.Request(release_url, headers={"User-Agent": "AntigravityHarness-Installer/1.2.7"})
